...
properties(
    [
        ...
        parameters([
            choice(name: 'SUITE_NAME', choices: ['Composer_Smoke - Chrome', 'Composer_Smoke - Safari', 'Link_Previews - Chrome', 'Link_Previews - Safari', 'Planner_Regression - Chrome', 'Planner_Regression - Safari'], description: 'Select a suite to run'),
            choice(name: 'FEATURE', choices: ['composer_smoke', 'link_previews', 'link_settings', 'planner_regression'], description: 'Select product feature'),
        ]),
    ]
)
